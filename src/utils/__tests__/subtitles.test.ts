...
describe('combineSubtitles', () => {
  ...
  it('handles only video subtitles', () => {
    const videoSubs: TextTrack[] = [createVideoSubtitle(0, 'en'), createVideoSubtitle(1, 'de')];
  ...
  it('groups subtitles by language with preferred languages first', () => {
    const videoSubs: TextTrack[] = [createVideoSubtitle(0, 'en'), createVideoSubtitle(1, 'es')];
